    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="row SearchBar">
                ...
                <div class="col-md-8" >
                    <a class="btn btn-success" style="float:right;min-width:75px;" id="" href="{{ route('variants.create') }}">Add</a>
                    <a class="btn btn-danger" style="float:right;margin-right:10px;" id="" href="{{route('variants.index', ['trash' => true])}}">Check Trash</a>
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script>
        function deleteRecord(id){
            ...
            var url = "{{route('variants.destroy', '')}}"+"/"+id;
