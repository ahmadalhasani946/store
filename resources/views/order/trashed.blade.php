    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="row SearchBar">
                ...
                <div class="col-md-8" >
                    <a class="btn btn-danger" style="float:right;min-width:100px;margin-right: 10px" href="{{ route('orders.index') }}">Go Back To Orders</a>
                </div>
...
@push('scripts')
    <script>
        function forceDelete(id){
            document.getElementById("DeletionForm").action = "{{route('orders.forceDelete', '')}}"+"/"+id;
        }
