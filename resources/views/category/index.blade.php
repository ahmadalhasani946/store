    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="row SearchBar">
                ...
                <div class="col-md-8" >
                    <a class="btn btn-success" style="float:right;min-width:75px;" href="{{ route('categories.create') }}">Add</a>
                    <a class="btn btn-danger" style="float:right;min-width:100px;margin-right: 10px" href="{{ route('categories.index',['trash' => true]) }}">Check Trash</a>
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script>
        function deleteRecord(id){
            document.getElementById("DeletionForm").action = "{{route('categories.destroy', '')}}"+"/"+id;
        }
